...
require_executable_or_file "$SCRIPT_DIR/app_priority_report.sh"
require_executable_or_file "$SCRIPT_DIR/app_priority_apply.sh"
require_executable_or_file "$SCRIPT_DIR/app_priority_restore.sh"
